...
* **Checkpoint System:** Never lose data! The script saves progress to a local JSON file (`veri_yedek.json`) after each successful AI parsing. If the script crashes or rate limits are hit, it resumes exactly where it left off.
...
4. Watch the logs as it navigates categories, extracts links, parses text via AI, and saves the final output to Excel!
